...
- Suggested order, one per day. It mixes the lots and keeps similar reels at least two slots apart (Smart Money: 21/22/23/24 · Today: 04/12/25/26/27/29 · AI: 03/15/16/20 · pricing: 05/16/17 · ETF: 07/10/18): V2-17 → V2-14 → V2-01 → V2-11 → V2-21 → V2-12 → V2-02 → V2-23 → V2-04 → V2-15 → V2-26 → V2-10 → V2-22 → V2-18 → V2-03 → V2-07 → V2-27 → V2-16 → V2-19 → V2-24 → V2-05 → V2-13 → V2-25 → V2-09 → V2-28 → V2-08 → V2-20 → V2-29 → V2-06 → V2-30.
- V2-17 opens the run: Sami marked it “à poster ASAP” on the review page.
- Hand-off to the Buffer session: `HANDOFF-BUFFER.md` (rules, traffic plan, order) and `posting_plan.json` (the 30 reels in order, with video, cover, Instagram and X captions, hashtags and first comment copied verbatim from the sheets, plus an optional UTM link per reel to measure traffic).
