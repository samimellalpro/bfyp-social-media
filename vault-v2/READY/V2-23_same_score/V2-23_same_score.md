...
| | |
|---|---|
| Reel (final) | `V2-23_same_score-198ce15bdd.mp4` — 20.40 s · 1080×1920 · 30 fps · H.264 High · AAC 48 kHz stereo · 7.57 MB |
| Cover | `V2-23_same_score_cover-a54c4a3ee3.png` — 1080×1920 (key text inside the 3:4 grid-safe area) |
| Format | Text-led · Spot the difference (split screen) |
...
- [x] Sound: original music + sound design (whoosh×4, impact×2, hit×2, pop×2, ding×1, sparkle×1)
