...
| | |
|---|---|
| Reel (final) | `V2-02_gurus_100m-c856c5eae2.mp4` — 20.60 s · 1080×1920 · 30 fps · H.264 High · AAC 48 kHz stereo · 10.3 MB |
| Cover | `V2-02_gurus_100m_cover-df207b7816.png` — 1080×1920 (key text inside the 3:4 grid-safe area) |
| Format | Text-led · Press-release hook → insider forms |
...
| Hook (≤ 1.5 s) | “8 “trading gurus.” $100M. SEC charges.” |
...
| Bitrate / size | 3999 kb/s · 10.3 MB |
| All gates | **PASS** |

### Editorial
- [x] Hook readable within 1.5 s: “8 “trading gurus.” $100M. SEC charges.”
...
- [x] Sound: original music + sound design (hit×4, swish×3, click×3, impact×2, subdrop×1, riser×1, ding×1, scan×1, whoosh×1, pop×1, sparkle×1)
